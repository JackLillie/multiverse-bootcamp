...
async function sandbox() {
  ...
  const mcdonalds = await Company.create({
    name: "McDonald's",
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/McDonald%27s_Golden_Arches.svg/2339px-McDonald%27s_Golden_Arches.svg.png",
  });
  ...
  const mcdonaldsNorwich = await mcdonalds.createLocation({
    name: "Norwich",
    capacity: 75,
    manager: "Ben",
  });
